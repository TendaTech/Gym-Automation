...
class ApiService {
  ...
  async login(email: string, password: string) {
    const response = await fetch(
      `${API_BASE_URL.replace("/api/members/api", "")}/auth/login/`,
      {
        method: "POST",
  ...
  async register(userData: any) {
    const response = await fetch(
      `${API_BASE_URL.replace("/api/members/api", "")}/auth/register/`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async getMemberDashboard(memberId: string) {
    const response = await fetch(
      `${API_BASE_URL}/members/${memberId}/dashboard/`,
      {
        headers: this.getAuthHeaders(),
      }
    );
  ...
  async joinTrainingSession(sessionId: string) {
    const response = await fetch(
      `${API_BASE_URL}/training-sessions/${sessionId}/join/`,
      {
        method: "POST",
        headers: this.getAuthHeaders(),
      }
  ...
  async leaveTrainingSession(sessionId: string) {
    const response = await fetch(
      `${API_BASE_URL}/training-sessions/${sessionId}/leave/`,
      {
        method: "POST",
        headers: this.getAuthHeaders(),
      }
