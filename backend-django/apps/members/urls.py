...
urlpatterns = [
    ...
    # Email management
    path('api/emails/logs/', views.EmailLogListView.as_view(), name='email-log-list'),
    ...
    # Member Portal
    path('api/portal/dashboard/', views.MemberPortalDashboardView.as_view(), name='member-portal-dashboard'),
